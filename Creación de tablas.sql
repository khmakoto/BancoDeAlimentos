...
CREATE TABLE Movimientos(
	IDMovimientos INT PRIMARY KEY NOT NULL,
	IDArea NVARCHAR(6) NULL,
	IDPrograma NVARCHAR(6) NULL,
	IDDonante NVARCHAR(8) NOT NULL,
	IDProveedor NVARCHAR(8) NULL,
	IDGrupoRef NVARCHAR(10) NULL,
	IDInstitucion NVARCHAR(10) NULL,
	...
	FolioDon NVARCHAR(10) NULL,
	Factura NVARCHAR(10) NULL,
	IDSucursal NVARCHAR(15) NULL,
	Origen NVARCHAR(1) NULL,
	StatusMov NVARCHAR(8) NULL,
	Familias INT NULL,
	Integrantes INT NULL,
	FolioEntrada NCHAR(10) NULL,
	Descuento FLOAT NULL,
	Paquete FLOAT NULL,
	FechaSist DATETIME NULL,
	FOREIGN KEY(IDArea) REFERENCES Areas(IDArea),
	FOREIGN KEY(IDPrograma) REFERENCES Programas(IDPrograma),
	FOREIGN KEY(IDDonante) REFERENCES Donantes(IDDonante),
	...
	FOREIGN KEY(FolioEntrada) REFERENCES FoliosEntrada(FolioEntrada)
);

CREATE TABLE Recibo(
	IDRecibo INT PRIMARY KEY NOT NULL,
	IDArea NVARCHAR(6) NULL,
	IDPrograma NVARCHAR(6) NULL,
	IDDonante NVARCHAR(8) NOT NULL,
	IDProveedor NVARCHAR(8) NULL,
...
CREATE TABLE TablaTmp(
	IDFolio NVARCHAR(10) NOT NULL,
	IDInstitucion NVARCHAR(10) NOT NULL,
	Total NUMERIC(18,2) NOT NULL,
	TotalCDescto NUMERIC(18,2) NOT NULL,
	PorcDescto NUMERIC(18,2) NOT NULL,
	PRIMARY KEY(IDFolio, IDInstitucion),
	FOREIGN KEY(IDInstitucion) REFERENCES Instituciones(IDInstitucion)
);

CREATE TABLE tablaTmpDon(
	IDInstitucion NVARCHAR(10) NOT NULL,
	Institucion NVARCHAR(50) NULL,
	Area NVARCHAR(50) NULL,
	Programa NVARCHAR(50) NULL,
	IDFolioCarAbo NCHAR(10) NULL,
	IDFolio NVARCHAR(10) NULL,
	FechaMov DATETIME NULL,
	Donativo NUMERIC(18,2) NULL,
	FOREIGN KEY(IDInstitucion) REFERENCES Instituciones(IDInstitucion),
	FOREIGN KEY(IDFolioCarAbo) REFERENCES FoliosCarAbo(FolioCarAbo)
);

CREATE TABLE Vales(
	IDVales INT PRIMARY KEY NOT NULL,
	IDPrograma NVARCHAR(6) NULL,
	IDArea NVARCHAR(6) NULL,
	IDInstitucion NVARCHAR(10) NULL,
	IDFolio NVARCHAR(10) NOT NULL,
	Fecha DATETIME NULL,
	Paquetes INT NULL,
	PrecioPaq FLOAT NULL,
	OtrosCargos FLOAT NULL,
	Estatus NVARCHAR(10) NULL,
	FolioMov NVARCHAR(10) NULL,
	Flete FLOAT NULL,
	Total FLOAT NULL,
	Saldo FLOAT NULL,
	Personas INT NULL,
...
CREATE TABLE Vista_4(
	IDInstitucion NVARCHAR(10) NOT NULL,
	IDFolioCarAbo NCHAR(10) NOT NULL,
	TipoMov NVARCHAR(10) NULL,
	IDFolio NVARCHAR(10) NULL,
	FechaMov DATETIME NULL,
	Importe NUMERIC(18,2) NULL,
	...
	Donativo NUMERIC(18,2) NULL,
	Incobrable NUMERIC(18,2) NULL,
	PRIMARY KEY(IDInstitucion, IDFolioCarAbo),
	FOREIGN KEY(IDInstitucion) REFERENCES Instituciones(IDInstitucion),
	FOREIGN KEY(IDFolioCarAbo) REFERENCES FoliosCarAbo(FolioCarAbo)
);